...
-- Reconciled from the verified Supabase Production state on 2026-08-21.
-- Canonical role assignment table: public.admin_user_roles.
...
-- Match Production execution privileges explicitly.
