        ...
        <div className="container legal-layout">
          ...
          >
            {isLoading ? (
              ...
              <div className="legal-notice">
                {isArabic
                  ? "تعذر تحميل الشروط والأحكام حاليًا."
                  : "The Terms and Conditions could not be loaded at this time."}
              </div>
            ) : sections.length === 0 ? (
              <div className="legal-notice">
                {isArabic
                  ? "لا توجد نسخة منشورة من الشروط والأحكام حاليًا."
                  : "No published Terms and Conditions are currently available."}
              </div>
            ) : (
              <>
                <div className="legal-notice">
