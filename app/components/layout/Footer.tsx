...
export default function Footer({ t, language }: { t: HomeCopy; language: Language }) {
  return <footer className="nr-footer"><div className="nr-container nr-footer-content">
    <div className="nr-footer-brand"><Image src="/images/site/v-logo.png" alt="NourApp" width={170} height={58} /><span>{t.footer}</span></div>
    <div className="nr-footer-contact"><a href="tel:+966567488377" dir="ltr">+966 56 748 8377</a><a href="https://NourAppappglobal.com" target="_blank" rel="noreferrer">NourAppappglobal.com</a></div>
